    ...
    checkExclusions(opts.exclusions,
      function(){
        ...
        if(opts.auto_preload){
          jsPsych.pluginAPI.autoPreload(timeline, startExperiment, opts.preload_images, opts.preload_audio, opts.preload_video, opts.show_preload_progress_bar, opts.intro_text);
...
jsPsych.pluginAPI = (function() {
  ...
  module.autoPreload = function(timeline, callback, images, audio, video, progress_bar, intro_text) {
    ...
    if(progress_bar){
      var pb_html = "<div id='preload_intro_text'>" + intro_text + "</div>";
